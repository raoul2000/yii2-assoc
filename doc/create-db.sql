...
CREATE TABLE IF NOT EXISTS `bank_account` (
  ...
  `created_at` DATETIME NULL DEFAULT NULL,
  `updated_at` DATETIME NULL DEFAULT NULL,
  `initial_value` DECIMAL(13,2) NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `transaction` (
  ...
  `value` DECIMAL(13,2) UNSIGNED NULL DEFAULT NULL,
  ...
  `orders_value_total` DECIMAL(13,2) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tag_has_transaction` ;
...
CREATE TABLE IF NOT EXISTS `product` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
  `value` DECIMAL(13,2) NULL DEFAULT NULL,
  `created_at` DATETIME NULL DEFAULT NULL,
  `updated_at` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `tag_has_contact`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tag_has_contact` ;

CREATE TABLE IF NOT EXISTS `tag_has_contact` (
  `tag_id` INT(10) UNSIGNED NOT NULL,
  `contact_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`tag_id`, `contact_id`),
  INDEX `fk_contact_has_tag_tag1_idx` (`tag_id` ASC),
  INDEX `fk_contact_has_tag_contact1_idx` (`contact_id` ASC),
  CONSTRAINT `fk_contact_has_tag_contact1`
    FOREIGN KEY (`contact_id`)
    REFERENCES `contact` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contact_has_tag_tag1`
    FOREIGN KEY (`tag_id`)
    REFERENCES `tag` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
