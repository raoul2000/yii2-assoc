...
-- Schema yii2_assoc
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `yii2_assoc` DEFAULT CHARACTER SET utf8 ;
USE `yii2_assoc` ;

-- -----------------------------------------------------
-- Table `yii2_assoc`.`address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`address` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`arhistory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`arhistory` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`attachment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`attachment` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`auth_rule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`auth_rule` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`auth_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`auth_item` (
  `name` VARCHAR(64) NOT NULL,
  ...
  CONSTRAINT `auth_item_ibfk_1`
    ...
    REFERENCES `yii2_assoc`.`auth_rule` (`name`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`auth_assignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`auth_assignment` (
  ...
  CONSTRAINT `auth_assignment_ibfk_1`
    ...
    REFERENCES `yii2_assoc`.`auth_item` (`name`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`auth_item_child`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`auth_item_child` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`contact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`contact` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_contact_address1`
    ...
    REFERENCES `yii2_assoc`.`address` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 5
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`bank_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`bank_account` (
  ...
  CONSTRAINT `fk_bank_account_contact1`
    ...
    REFERENCES `yii2_assoc`.`contact` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`category` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`config` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`migration`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`migration` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`product` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`order` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_product1`
    ...
    REFERENCES `yii2_assoc`.`product` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`transaction_pack`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`transaction_pack` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_transaction_pack_bank_account1`
    ...
    REFERENCES `yii2_assoc`.`bank_account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`transaction` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_transaction_category1`
    ...
    REFERENCES `yii2_assoc`.`category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_transaction_transaction_pack1`
    FOREIGN KEY (`transaction_pack_id`)
    REFERENCES `yii2_assoc`.`transaction_pack` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`order_transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`order_transaction` (
  ...
  CONSTRAINT `fk_order_has_transaction_order1`
    ...
    REFERENCES `yii2_assoc`.`order` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`user` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`profile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`profile` (
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`session`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`session` (
  `id` CHAR(40) NOT NULL,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`social_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`social_account` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `yii2_assoc`.`token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yii2_assoc`.`token` (
  `user_id` INT(11) NULL DEFAULT NULL,
